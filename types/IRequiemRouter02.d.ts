...
interface IRequiemRouter02Interface extends ethers.utils.Interface {
  functions: {
...
export class IRequiemRouter02 extends BaseContract {
  ...
  interface: IRequiemRouter02Interface;
