...
interface IRequiemRouter01Interface extends ethers.utils.Interface {
  functions: {
...
export class IRequiemRouter01 extends BaseContract {
  ...
  interface: IRequiemRouter01Interface;
